...
/** TODO: confirmar acréscimo das linhas VIP com a Girassol (não consta no cardápio recebido). */
const vip = { brl: 10, ars: 3000 };
const doceVip = { brl: 5, ars: 1500 };
...
const f = (
  ...
  description,
  group,
  extra: group === "vip" ? vip : group === "doce-vip" ? doceVip : none,
  color,
  bits,
  available: true,
});
...
export const pizzaFlavors: PizzaFlavor[] = [
  ...
  // ── VIP ── (descrições não constam no cardápio recebido)
  f(29, "nachos", "Nachos", "", "vip", "#F1D48A", "#D9822B"),
  f(30, "coracao", "Coração", "", "vip", "#EBC98E", "#8A3A2A"),
  f(31, "file-fritas", "Filé com Fritas", "", "vip", "#F2D896", "#7E4A2E"),
  // ── Doces ──
  f(32, "banana", "Banana", "", "doce", "#EFD28C", "#B98748"),
  f(33, "dois-amores", "Dois Amores", "", "doce", "#8B5A3C", "#F6EFDA"),
  f(34, "charge", "Charge", "", "doce", "#5A3826", "#C9924A"),
  f(35, "sensacao", "Sensação", "", "doce", "#6B3A2A", "#D9452F"),
  withImg(f(36, "mm", "M&M", "", "doce", "#6B3A2A", "#E6B422"), "pizza-doce-mm"),
  f(37, "marshmallow", "Marshmallow", "", "doce", "#7A4A34", "#FFFFFF"),
  f(38, "doce-da-casa", "Da Casa", "", "doce", "#7A4A34", "#F2C230"),
  f(39, "bis", "Bis", "", "doce", "#5A3826", "#3A2418"),
  f(40, "abacaxi", "Abacaxi", "", "doce", "#F4E2A4", "#E7B93A"),
  // ── Doces VIP ──
  f(41, "prestigio", "Prestígio", "", "doce-vip", "#5A3826", "#FFFFFF"),
  f(42, "sensacao-branca-kiwi", "Sensação Branca com Kiwi", "", "doce-vip", "#F6EFDA", "#7BB35A"),
  f(43, "sonho-de-valsa", "Sonho de Valsa", "", "doce-vip", "#6B3A2A", "#C9924A"),
  f(44, "ouro-branco", "Ouro Branco", "", "doce-vip", "#F6EFDA", "#C9924A"),
  f(45, "pacoca", "Paçoca", "", "doce-vip", "#E8C58A", "#B98748"),
];
